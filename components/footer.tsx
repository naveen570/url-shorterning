...
export const Footer = () => {
  ...
  return (
    <>
      <footer className=" bg-neutral-very-dark-violet py-20 text-white">
        <div className="container flex flex-col items-center gap-8 md:flex-row md:items-start md:justify-between md:gap-0">
          ...
          <div className="grid items-center gap-12 md:grid-cols-3 md:items-start">
            {details.map((x) => (
              <div
          ...
          <div className="flex items-center gap-6">
            {socials.map((Slogo, i) => (
              <Link href={"/"} key={`social-${i}`} className="group">
                <Slogo className="hover:fill-primary-cyan" />
              </Link>
            ))}
          </div>
        </div>
      ...
      <div className="flex items-center justify-center">
        <Link
          href={"https://github.com/naveen570/url-shorterning"}
          className="underline"
          target="_blank"
        >
          Naveen Kumar A M
